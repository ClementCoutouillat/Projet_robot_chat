...
C_SRCS += \
../Core/mylibs/board/board.c 

OBJS += \
./Core/mylibs/board/board.o 

C_DEPS += \
./Core/mylibs/board/board.d 


# Each subdirectory must supply rules for building sources it contributes
Core/mylibs/board/%.o Core/mylibs/board/%.su Core/mylibs/board/%.cyclo: ../Core/mylibs/board/%.c Core/mylibs/board/subdir.mk
...
clean: clean-Core-2f-mylibs-2f-board

clean-Core-2f-mylibs-2f-board:
	-$(RM) ./Core/mylibs/board/board.cyclo ./Core/mylibs/board/board.d ./Core/mylibs/board/board.o ./Core/mylibs/board/board.su

.PHONY: clean-Core-2f-mylibs-2f-board
